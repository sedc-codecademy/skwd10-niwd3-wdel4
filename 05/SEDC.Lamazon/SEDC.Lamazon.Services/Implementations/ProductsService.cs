...
namespace SEDC.Lamazon.Services.Implementations
{
    public class ProductsService : IProductsService
    {
        ...
        public PagedResultViewModel<ProductViewModel> GetFilteredProducts(DatatableRequestViewModel datatableRequestViewModel)
        {
            var searchValue = datatableRequestViewModel.search?.value ?? string.Empty;
            var productCategoriesPagedResult = _productRepository.GetFilteredProducts(datatableRequestViewModel.start, datatableRequestViewModel.length, searchValue, datatableRequestViewModel.sortColumn, datatableRequestViewModel.isAscending);
