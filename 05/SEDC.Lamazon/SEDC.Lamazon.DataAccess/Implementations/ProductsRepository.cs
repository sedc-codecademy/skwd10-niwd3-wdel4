...
namespace SEDC.Lamazon.DataAccess.Implementations
{
    public class ProductsRepository : BaseRepository, IProductsRepository
    {
        ...
        public PagedResultModel<Product> GetFilteredProducts(int startIndex, int count, string searchValue, string orderByColumn, bool isAscending)
        {
            ...
            productsQuery = productsQuery.Where(x => x.Name.Contains(searchValue) || x.ProductCategory.Name.Contains(searchValue));
